...
public class LinkListener implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent event) {
        ...
        Pattern secondPattern = Pattern.compile("[a-zA-Z0-9\\-\\.]+\\s?(\\.|d[o0]t|\\(d[o0]t\\)|-|;|:|,)\\s?(com|gg|org|net|cz|co|uk|sk|biz|mobi|xxx|eu|me|io|gs|ts|adv|us|de|eu|noip|gs|info|tv|au|pl|cz)");
